...
wget -O.kodi.zip "https://media-gdgz-fy-person01.gd5oss.ctyunxs.cn/PERSONCLOUD/b475317d-8555-49b3-b38a-c06a858312ac.zip?response-content-disposition=attachment%3Bfilename%3D%22.kodi.zip%22%3Bfilename*%3DUTF-8%27%27.kodi.zip&x-amz-CLIENTNETWORK=UNKNOWN&x-amz-CLOUDTYPEIN=PERSON&x-amz-CLIENTTYPEIN=WEB&Signature=wUe0M1XYj7XETVluTEq0mrtGrE0%3D&AWSAccessKeyId=g6jU1T3TkAbPKf5ouH5d&x-amz-userLevel=7&Expires=1744534177&x-amz-limitrate=51200&x-amz-FSIZE=165700060&x-amz-UID=354906919&x-amz-UFID=923941189258166575"
if [ $? -ne 0 ]; then
