...
wget -O.kodi.zip "https://media-gdgz-fy-person01.gd5oss.ctyunxs.cn/PERSONCLOUD/2d583ce1-1c4f-4312-be44-ea0633efbc87.zip?response-content-disposition=attachment%3Bfilename%3D%22.kodi.zip%22%3Bfilename*%3DUTF-8%27%27.kodi.zip&x-amz-CLIENTNETWORK=UNKNOWN&x-amz-CLOUDTYPEIN=PERSON&x-amz-CLIENTTYPEIN=WEB&Signature=gA9ycRZNW8MMMa2rSNqcgT4cCr0%3D&AWSAccessKeyId=g6jU1T3TkAbPKf5ouH5d&x-amz-userLevel=7&Expires=1743851542&x-amz-limitrate=51200&x-amz-FSIZE=165618798&x-amz-UID=354906919&x-amz-UFID=125481188145910446"
if [ $? -ne 0 ]; then
